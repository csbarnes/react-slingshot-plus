# React Slingshot Plus

React Slingshot Plus is an application restructuring of [react-slingshot](https://github.com/coryhouse/react-slingshot) to facilitate the scaling of complex applications. Slingshot Plus contains the [redux-devtools](https://github.com/gaearon/redux-devtools). 

Included is an example app composed of the original slingshot example app and the todomvc app from [redux](https://github.com/rackt/redux). This isn't an ideal example and will be updated in the future but for now it is useful to mock a "complex" application and showcase a more scalable structure.
